defmodule ExVrp.Native do
  ...
  @nifs create_problem_data: 1,
        ...
        problem_data_distance_matrix_nif: 2,
        ...
        local_search_with_operators_nif: 4,
        local_search_stats_nif: 4,
        ...
        solution_route_delivery: 2,
        solution_route_pickup: 2,
        solution_route_is_feasible: 2,
        solution_route_excess_load: 2,
        ...
        solution_route_service_duration: 2,
        solution_route_travel_duration: 2,
        ...
        search_route_vehicle_type_nif: 1,
        search_route_num_clients_nif: 1,
        search_route_num_depots_nif: 1,
        search_route_num_trips_nif: 1,
        search_route_max_trips_nif: 1,
        search_route_size_nif: 1,
        search_route_empty_nif: 1,
        search_route_is_feasible_nif: 1,
        search_route_has_excess_load_nif: 1,
        search_route_has_excess_distance_nif: 1,
        search_route_has_time_warp_nif: 1,
        ...
        search_route_excess_load_nif: 1,
        search_route_capacity_nif: 1,
        search_route_start_depot_nif: 1,
        search_route_end_depot_nif: 1,
        search_route_fixed_vehicle_cost_nif: 1,
        search_route_distance_cost_nif: 1,
        ...
        search_route_insert_nif: 3,
        search_route_remove_nif: 2,
        ...
        search_route_dist_between_nif: 4,
        search_route_dist_at_nif: 3,
        search_route_dist_before_nif: 2,
        search_route_dist_after_nif: 2,
        make_search_route_nif: 4,
        create_search_node_nif: 2,
        search_node_client_nif: 1,
        search_node_idx_nif: 1,
        search_node_trip_nif: 1,
        search_node_is_depot_nif: 1,
        search_node_is_start_depot_nif: 1,
        search_node_is_end_depot_nif: 1,
        search_node_is_reload_depot_nif: 1,
        search_node_has_route_nif: 1,
        create_exchange10_nif: 1,
        create_exchange11_nif: 1,
        create_exchange20_nif: 1,
        create_exchange21_nif: 1,
        create_exchange22_nif: 1,
        create_exchange30_nif: 1,
        create_exchange31_nif: 1,
        create_exchange32_nif: 1,
        create_exchange33_nif: 1,
        exchange10_evaluate_nif: 4,
        exchange10_apply_nif: 3,
        exchange11_evaluate_nif: 4,
        exchange11_apply_nif: 3,
        exchange20_evaluate_nif: 4,
        exchange20_apply_nif: 3,
        exchange21_evaluate_nif: 4,
        exchange21_apply_nif: 3,
        exchange22_evaluate_nif: 4,
        exchange22_apply_nif: 3,
        exchange30_evaluate_nif: 4,
        exchange30_apply_nif: 3,
        exchange31_evaluate_nif: 4,
        exchange31_apply_nif: 3,
        exchange32_evaluate_nif: 4,
        ...
        rng_randint_nif: 2,
        rng_state_nif: 1,
        create_dynamic_bitset_nif: 1,
        dynamic_bitset_len_nif: 1,
        dynamic_bitset_get_nif: 2,
        dynamic_bitset_set_bit_nif: 3,
        dynamic_bitset_all_nif: 1,
        dynamic_bitset_any_nif: 1,
        dynamic_bitset_none_nif: 1,
        dynamic_bitset_count_nif: 1,
        dynamic_bitset_set_all_nif: 1,
        dynamic_bitset_reset_all_nif: 1,
        dynamic_bitset_or_nif: 2,
        dynamic_bitset_and_nif: 2,
        dynamic_bitset_xor_nif: 2,
        ...
        duration_segment_end_late_nif: 1,
        duration_segment_prev_end_late_nif: 1,
        duration_segment_release_time_nif: 1,
        duration_segment_slack_nif: 1,
        duration_segment_finalise_back_nif: 1,
        duration_segment_finalise_front_nif: 1,
        create_load_segment_nif: 4,
        load_segment_merge_nif: 2,
        load_segment_finalise_nif: 2,
        load_segment_delivery_nif: 1,
        load_segment_pickup_nif: 1,
        load_segment_load_nif: 1,
        load_segment_excess_load_nif: 2,
        create_perturbation_manager_nif: 2,
        perturbation_manager_min_perturbations_nif: 1,
        perturbation_manager_max_perturbations_nif: 1,
        perturbation_manager_num_perturbations_nif: 1,
        perturbation_manager_shuffle_nif: 2
  @on_load :load_nif
  @doc false
  def load_nif do
  ...
  defp create_cost_evaluator_nif(_opts) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_penalised_cost(_solution, _cost_evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_cost(_solution, _cost_evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp create_random_solution_nif(_problem_data, _opts) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def problem_data_num_vehicles(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def problem_data_num_profiles_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  """
  @spec problem_data_clients_nif(reference()) :: [{integer(), integer(), integer(), integer()}]
  def problem_data_clients_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def problem_data_distance_matrix_nif(_problem_data, _profile) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def problem_data_duration_matrix_nif(_problem_data, _profile) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  """
  @spec problem_data_vehicle_types_nif(reference()) :: [{integer(), integer(), integer()}]
  def problem_data_vehicle_types_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def problem_data_groups_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp local_search_nif(_solution, _problem_data, _cost_evaluator, _opts) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp local_search_search_only_nif(_solution, _problem_data, _cost_evaluator, _opts) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp local_search_with_operators_nif(_solution, _problem_data, _cost_evaluator, _opts) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp local_search_stats_nif(_solution, _problem_data, _cost_evaluator, _opts) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp create_local_search_nif(_problem_data, _seed) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  @spec local_search_run(reference(), reference(), reference(), non_neg_integer()) ::
          {:ok, reference()} | {:error, term()}
  def local_search_run(local_search, solution, cost_evaluator, timeout_ms \\ 0) do
    local_search_run_nif(local_search, solution, cost_evaluator, timeout_ms)
  end

  defp local_search_run_nif(_local_search, _solution, _cost_evaluator, _timeout_ms) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  defp local_search_search_run_nif(_local_search, _solution, _cost_evaluator, _timeout_ms) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_distance(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_duration(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_delivery(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_pickup(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_is_feasible(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_service_duration(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_travel_duration(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_wait_duration(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_distance_cost(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_visits(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def solution_route_schedule(_solution, _route_idx) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Returns the total fixed vehicle cost of the solution."
  @spec solution_fixed_vehicle_cost(reference()) :: non_neg_integer()
  def solution_fixed_vehicle_cost(_solution) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a new search route."
  def create_search_route_nif(_problem_data, _idx, _vehicle_type) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route index."
  def search_route_idx_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route vehicle type."
  def search_route_vehicle_type_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the number of clients in the route."
  def search_route_num_clients_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the number of depots in the route."
  def search_route_num_depots_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the number of trips in the route."
  def search_route_num_trips_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the max trips allowed for the route."
  def search_route_max_trips_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route size (total nodes including depots)."
  def search_route_size_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route is empty."
  def search_route_empty_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route is feasible."
  def search_route_is_feasible_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route has excess load."
  def search_route_has_excess_load_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route has excess distance."
  def search_route_has_excess_distance_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route has time warp."
  def search_route_has_time_warp_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route distance."
  def search_route_distance_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route duration."
  def search_route_duration_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route time warp."
  def search_route_time_warp_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route overtime."
  def search_route_overtime_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route excess distance."
  def search_route_excess_distance_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route load (as list)."
  def search_route_load_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route excess load (as list)."
  def search_route_excess_load_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route capacity (as list)."
  def search_route_capacity_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route start depot."
  def search_route_start_depot_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route end depot."
  def search_route_end_depot_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the fixed vehicle cost."
  def search_route_fixed_vehicle_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the distance cost."
  def search_route_distance_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the duration cost."
  def search_route_duration_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the unit distance cost."
  def search_route_unit_distance_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the unit duration cost."
  def search_route_unit_duration_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route centroid."
  def search_route_centroid_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route profile."
  def search_route_profile_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets a node at the given index."
  def search_route_get_node_nif(_route, _idx) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Appends a node to the route."
  def search_route_append_nif(_route, _node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Inserts a node at the given index."
  def search_route_insert_nif(_route, _idx, _node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Removes the node at the given index."
  def search_route_remove_nif(_route, _idx) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Clears the route."
  def search_route_clear_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Updates the route (recomputes statistics)."
  def search_route_update_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Swaps two nodes."
  def search_route_swap_nif(_node1, _node2) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if two routes overlap with the given tolerance (0.0 to 1.0)."
  def search_route_overlaps_with_nif(_route1, _route2, _tolerance) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route's shift duration."
  def search_route_shift_duration_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route's max overtime."
  def search_route_max_overtime_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route's max duration (shift_duration + max_overtime)."
  def search_route_max_duration_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the route's unit overtime cost."
  def search_route_unit_overtime_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route has distance cost."
  def search_route_has_distance_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the route has duration cost."
  def search_route_has_duration_cost_nif(_route) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets distance between two indices. Profile -1 uses route's default."
  def search_route_dist_between_nif(_route, _start, _end, _profile) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets distance at specific index. Profile -1 uses route's default."
  def search_route_dist_at_nif(_route, _idx, _profile) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets distance before index."
  def search_route_dist_before_nif(_route, _idx) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets distance after index."
  def search_route_dist_after_nif(_route, _idx) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a search route from a list of visits."
  def make_search_route_nif(_problem_data, _visits, _idx, _vehicle_type) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a new search node."
  def create_search_node_nif(_problem_data, _loc) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the node's location (client index)."
  def search_node_client_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the node's index in the route."
  def search_node_idx_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the node's trip index."
  def search_node_trip_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the node is a depot."
  def search_node_is_depot_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the node is a start depot."
  def search_node_is_start_depot_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the node is an end depot."
  def search_node_is_end_depot_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the node is a reload depot."
  def search_node_is_reload_depot_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Checks if the node has a route assigned."
  def search_node_has_route_nif(_node) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange10 (relocate) operator."
  def create_exchange10_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange11 (swap) operator."
  def create_exchange11_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange20 operator."
  def create_exchange20_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange21 operator."
  def create_exchange21_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange22 operator."
  def create_exchange22_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange30 operator."
  def create_exchange30_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange31 operator."
  def create_exchange31_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange32 operator."
  def create_exchange32_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates an Exchange33 operator."
  def create_exchange33_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange10 move cost."
  def exchange10_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange10 move."
  def exchange10_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange11 move cost."
  def exchange11_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange11 move."
  def exchange11_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange20 move cost."
  def exchange20_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange20 move."
  def exchange20_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange21 move cost."
  def exchange21_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange21 move."
  def exchange21_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange22 move cost."
  def exchange22_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange22 move."
  def exchange22_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange30 move cost."
  def exchange30_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange30 move."
  def exchange30_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange31 move cost."
  def exchange31_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange31 move."
  def exchange31_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange32 move cost."
  def exchange32_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange32 move."
  def exchange32_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates Exchange33 move cost."
  def exchange33_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies Exchange33 move."
  def exchange33_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a SwapStar operator with overlap_tolerance (0.0 to 1.0, use 1.0 to check all route pairs)."
  def create_swap_star_nif(_problem_data, _overlap_tolerance) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates SwapStar move cost between two routes."
  def swap_star_evaluate_nif(_op, _route1, _route2, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies SwapStar move between two routes."
  def swap_star_apply_nif(_op, _route1, _route2) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a SwapRoutes operator."
  def create_swap_routes_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates SwapRoutes move cost between two routes."
  def swap_routes_evaluate_nif(_op, _route1, _route2, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies SwapRoutes move between two routes."
  def swap_routes_apply_nif(_op, _route1, _route2) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a SwapTails operator."
  def create_swap_tails_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Creates a RelocateWithDepot operator."
  def create_relocate_with_depot_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates SwapTails move cost."
  def swap_tails_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies SwapTails move."
  def swap_tails_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Evaluates RelocateWithDepot move cost."
  def relocate_with_depot_evaluate_nif(_op, _u, _v, _evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Applies RelocateWithDepot move."
  def relocate_with_depot_apply_nif(_op, _u, _v) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def relocate_with_depot_supports_nif(_problem_data) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  """
  def insert_cost_nif(_u_node, _v_node, _problem_data, _cost_evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  """
  def remove_cost_nif(_u_node, _problem_data, _cost_evaluator) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def duration_segment_merge_nif(_edge_duration, _first, _second) do
    :erlang.nif_error(:nif_not_loaded)
  end

  @doc "Gets the duration of a segment."
  @spec duration_segment_duration_nif(reference()) :: integer()
  def duration_segment_duration_nif(_seg) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def perturbation_manager_num_perturbations_nif(_pm) do
    :erlang.nif_error(:nif_not_loaded)
  end
  ...
  def perturbation_manager_shuffle_nif(_pm, _rng) do
    :erlang.nif_error(:nif_not_loaded)
  end
end
