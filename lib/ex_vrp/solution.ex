defmodule ExVrp.Solution do
  ...
  @doc "Returns the total distance of the solution."
  @spec distance(t()) :: non_neg_integer()
  def distance(%__MODULE__{distance: distance}), do: distance

  @doc "Returns the total duration of the solution."
  ...
  @doc "Returns the penalised cost of the solution given a cost evaluator."
  ...
  @doc "Returns the number of routes in the solution."
  ...
  @doc "Returns the number of assigned clients in the solution."
  @spec num_clients(t()) :: non_neg_integer()
  def num_clients(%__MODULE__{num_clients: num_clients}), do: num_clients

  @doc "Checks if the solution is feasible (satisfies all constraints)."
  @spec feasible?(t()) :: boolean()
  def feasible?(%__MODULE__{is_feasible: feasible}), do: feasible

  @doc "Checks if the solution is complete (visits all required clients)."
  ...
  @doc "Returns a list of unassigned client indices."
  ...
  @doc "Returns the total time warp of the solution (sum across all routes)."
  @spec time_warp(t()) :: non_neg_integer()
  def time_warp(%__MODULE__{} = sol) do
    sum_over_routes(sol, &route_time_warp/2)
  end

  @doc "Returns the total excess load of the solution per dimension."
  ...
  @doc "Returns the total excess distance of the solution (sum across all routes)."
  @spec excess_distance(t()) :: non_neg_integer()
  def excess_distance(%__MODULE__{} = sol) do
    sum_over_routes(sol, &route_excess_distance/2)
  end

  @doc "Returns the total overtime of the solution (sum across all routes)."
  ...
  @doc "Returns the distance of a specific route in the solution."
  ...
  @doc "Returns the duration of a specific route in the solution."
  ...
  @doc "Returns the delivery load of a specific route in the solution."
  ...
  @doc "Returns the pickup load of a specific route in the solution."
  ...
  @doc "Checks if a specific route in the solution is feasible."
  ...
  @doc "Returns the excess load of a specific route (per dimension)."
  ...
  @doc "Returns the time warp of a specific route."
  ...
  @doc "Returns the excess distance of a specific route."
  ...
  @doc "Returns the overtime of a specific route."
  ...
  @doc "Returns the vehicle type of a specific route."
  ...
  @doc "Returns the start depot of a specific route."
  ...
  @doc "Returns the end depot of a specific route."
  ...
  @doc "Returns the number of trips in a specific route."
  ...
  @doc "Returns the centroid of a specific route as {x, y}."
  ...
  @doc "Returns the start time of a specific route."
  ...
  @doc "Returns the end time of a specific route."
  ...
  @doc "Returns the slack time of a specific route."
  ...
  @doc "Returns the service duration of a specific route."
  ...
  @doc "Returns the travel duration of a specific route."
  ...
  @doc "Returns the wait duration of a specific route."
  ...
  @doc "Returns the distance cost of a specific route."
  ...
  @doc "Returns the duration cost of a specific route."
  ...
  @doc "Returns the reload cost of a specific route."
  ...
  @doc "Returns the prizes collected on a specific route."
  ...
  @doc "Returns the visits (client indices) of a specific route."
