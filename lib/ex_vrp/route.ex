defmodule ExVrp.Route do
  ...
  @doc "Checks if this route is feasible."
  ...
  @doc "Checks if this route has excess load in any dimension."
  ...
  @doc "Checks if this route has excess distance."
  ...
  @doc "Checks if this route has time warp."
  ...
  @doc "Returns the total delivery load of this route per dimension."
  ...
  @doc "Returns the distance of this route."
  ...
  @doc "Returns the duration of this route."
  ...
  @doc "Returns the excess distance of this route."
  ...
  @doc "Returns the time warp of this route."
  ...
  @doc "Returns the overtime of this route."
  ...
  @doc "Returns the distance cost of this route."
  ...
  @doc "Returns the duration cost of this route."
  ...
  @doc "Returns the start time of this route."
  ...
  @doc "Returns the end time of this route."
  ...
  @doc "Returns the travel duration of this route."
  ...
  @doc "Returns the wait duration of this route."
  ...
  @doc "Returns the vehicle type of this route."
  ...
  @doc "Returns the start depot of this route."
  ...
  @doc "Returns the end depot of this route."
  ...
  @doc "Returns the number of trips in this route."
