...
struct LocalSearchResource
{
    ...
    std::unique_ptr<search::Exchange<3, 0>> exchange30;
    std::unique_ptr<search::Exchange<3, 1>> exchange31;
    std::unique_ptr<search::Exchange<3, 2>> exchange32;
    std::unique_ptr<search::Exchange<3, 3>> exchange33;
    ...
    LocalSearchResource(std::shared_ptr<ProblemData> pd,
        ...
        : problemData(std::move(pd)),
          ...
          exchange30(std::make_unique<search::Exchange<3, 0>>(*problemData)),
          exchange31(std::make_unique<search::Exchange<3, 1>>(*problemData)),
          exchange32(std::make_unique<search::Exchange<3, 2>>(*problemData)),
          exchange33(std::make_unique<search::Exchange<3, 3>>(*problemData))
    {
        ...
        ls->addOperator(*exchange30);
        ls->addOperator(*exchange31);
        ls->addOperator(*exchange32);
        ls->addOperator(*exchange33);
        ...
        {
            replaceOptional = std::make_unique<search::ReplaceOptional>(
                data, ls->searchSpace());
